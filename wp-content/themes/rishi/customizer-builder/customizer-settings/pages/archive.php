...
$options = [
	'layouts_archive_options' => [
		...
		'inner-options'      => apply_filters( 'rishi__cb_:archive:inneroptions', [
			'archive_title_panel' => [
			...
			'archive_page_layout' => [
				'label'   => __('Archive Page Layout', 'rishi'),
				'desc'    => __('Choose the Archive page layout for your site.', 'rishi'),
