...
<p>
	<?php echo __('After installing and activating the performance extension you will be able to configure it from this location:', 'rishi-companion') ?>
</p>
	...
	<li>
		...
		<?php
			echo sprintf(
				...
				sprintf(
					'<code>%s</code>',
					__('Customizer ➝ Performance', 'rishi-companion')
				)
			);
		?>
		</i>
